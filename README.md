...
Stolen bikes are a typical problem in Delhi. The Police want to be more efficient in resolving stolen bike cases. They decided to build a software that can automate their processes — the software that you're going to develop.
...
- [ ] I want to see a list of reported bike thefts for the Delhi area.
...
For the layout of each page, please refer to the sample provided wireframes:
...
- [BikeIndex](https://bikeindex.org/bikes?serial=&button=&location=Delhi&distance=100&stolenness=proximity)
...
- Please complete your working solution within 3 days of receiving this challenge, and be sure to notify us when it is ready for review.
